...
class BLEPS_Parameters(Device):
    ...
    flow_1 = Component(EpicsSignalRO, "9idBLEPS:FLOW1_CURRENT", write_pv="9idBLEPS:FLOW1_SET_POINT")
    flow_2 = Component(EpicsSignalRO, "9idBLEPS:FLOW2_CURRENT", write_pv="9idBLEPS:FLOW2_SET_POINT")
    ...
    temperature_1_chopper = Component(EpicsSignalRO, "9idBLEPS:TEMP1_CURRENT", write_pv="9idBLEPS:TEMP1_SET_POINT")
    temperature_2 = Component(EpicsSignalRO, "9idBLEPS:TEMP2_CURRENT", write_pv="9idBLEPS:TEMP2_SET_POINT")
    temperature_3 = Component(EpicsSignalRO, "9idBLEPS:TEMP3_CURRENT", write_pv="9idBLEPS:TEMP3_SET_POINT")
    temperature_4 = Component(EpicsSignalRO, "9idBLEPS:TEMP4_CURRENT", write_pv="9idBLEPS:TEMP4_SET_POINT")
    temperature_5 = Component(EpicsSignalRO, "9idBLEPS:TEMP5_CURRENT", write_pv="9idBLEPS:TEMP5_SET_POINT")
    temperature_6 = Component(EpicsSignalRO, "9idBLEPS:TEMP6_CURRENT", write_pv="9idBLEPS:TEMP6_SET_POINT")
    temperature_7 = Component(EpicsSignalRO, "9idBLEPS:TEMP7_CURRENT", write_pv="9idBLEPS:TEMP7_SET_POINT")
    temperature_8 = Component(EpicsSignalRO, "9idBLEPS:TEMP8_CURRENT", write_pv="9idBLEPS:TEMP8_SET_POINT")
