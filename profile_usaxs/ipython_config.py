...
#         highlighting: 
#  bw, emacs, friendly, algol_nu, pastie, borland, monokai, vs, arduino, trac, rrt, lovelace, manni, tango, perldoc, paraiso-dark, colorful, rainbow_dash, autumn, default, fruity, paraiso-light, xcode, vim, native, igor, abap, algol, murphy
