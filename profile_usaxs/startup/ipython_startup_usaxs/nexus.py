...
# NOTE:this code to become part of
...
#from databroker.core import fill_event
...
def export(headers, filename, mds,
    ...
    with h5py.File(filename) as f:
        for header in headers:
            ...
            header.pop('_name')
            safe_attrs_assignment(nxentry_group, header)   # TODO: improve this
            ...
            for i, descriptor in enumerate(descriptors):
                ...
                safe_attrs_assignment(desc_group, descriptor)   # TODO: improve this
                ...
                for key, value in data_keys.items():
                    ...
                    value.pop("shape")
                    safe_attrs_assignment(dataset, dict(value))
...
def safe_attrs_assignment(node, d):
    d = clean_dict(d)
